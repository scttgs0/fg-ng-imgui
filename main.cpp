...
#include "View.gui"
#include "Options.gui"
#include "Location.gui"
#include "Autopilot.gui"
#include "Environment.gui"
#include "Equipment.gui"
#include "AI.gui"
#include "Multiplayer.gui"
#include "Debug.gui"
#include "Aircraft.gui"
...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        doMenuDebugDialogs();
        doMenuAircraftDialogs();
        doMenuServicesDialogs();
        doMenuHelpDialogs();
